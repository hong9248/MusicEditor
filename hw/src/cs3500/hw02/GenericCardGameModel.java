...
public interface GenericCardGameModel<K> {
   ...
   *
   * This string should be in the following format ({S} is space, {NL} is a newline, text in
   * italics are comments and do not appear in the string). Replace placeholders with actual data
   * as applicable:
   * <pre>
